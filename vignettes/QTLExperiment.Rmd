...
QTLExperiment can be installed from GitLab:

```{r install-qtlexperiment}
install.packages("devtools", repos = "http://cran.us.r-project.org")
devtools::install_git("https://gitlab.svi.edu.au/biocellgen-public/qtlexperiment.git", build_vignettes = FALSE)
library(QTLExperiment)
```
...
qtle2 <- mash2qtle(mashr_sim, rowData=DataFrame(feature_id=row.names(mashr_sim$Bhat),
