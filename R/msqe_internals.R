...
#' #' @description
#' #' Methods to get or set internal fields from the multiStateQTLExperiment class.
#' #' Thse functions are intended for package developers who want to add protected fields to a multiStateQTLExperiment.
#' #' They should \emph{not} be used by ordinary users of the \pkg{multiStateQTLExperiment} package.
#' #'
#' #' @section Getters:
#' #' In the following code snippets, \code{x} is a \linkS4class{multiStateQTLExperiment}.
#' #' \describe{
...
#' #' that are parallel to the rows or columns of a \linkS4class{multiStateQTLExperiment} class.
