...
#' the class structure. This is usually called by internal methods 
#' rather than by users or downstream packages.
#' 
...
setMethod("updateObject", "multiStateQTLExperiment", 
  ...
  #     # https://github.com/drisso/multiStateQTLExperiment/issues/37.
